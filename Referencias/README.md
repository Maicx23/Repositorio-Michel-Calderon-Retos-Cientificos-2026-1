...
En esta sección se encuentra las bases del proyecto, ya sean artículos, libros, o contenido multimedia que, de alguna forma ha sido utilizado en son de encontrar una solución al proyecto de clase, sin ningún tipo de orden dado.
...
- White, R. A., & Korst, H. H. (1972). The Determination of Vehicle Drag Contributions from Coast-Down Tests. SAE Technical Paper. (Cómo separar la resistencia del aire a la resistencia de la rodadura)
